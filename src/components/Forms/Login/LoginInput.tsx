  ...
  return (
    <>
      ...
      <input
        ...
        ref={ref}
        id={label}
        className={`peer relative py-3 px-4 placeholder:text-base-300 rounded-md border border-light-200 dark:border-neutral-700 placeholder-neutral-50 dark:placeholder-zinc-300 bg-transparent focus:ring-1 focus:outline-none focus:ring-offset-1 ${
          error
